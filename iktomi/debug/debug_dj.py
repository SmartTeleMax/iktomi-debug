...
def technical_500_response(env, exc_type, exc_value, tb):
    """
    Create a technical server error response. The last three arguments are
    the values returned from sys.exc_info() and friends.
    """
    reporter = ExceptionReporter(env, exc_type, exc_value, tb)
...
class ExceptionReporter:
    ...
    """
    def __init__(self, env, exc_type, exc_value, tb):
        self.env = env
    ...
    def get_traceback_html(self):
        ...
        environment = self.env.request.environ.items()
